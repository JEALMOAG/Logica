"""
Created on 16 April  23:17:41 2024
@author: Jesus Alejandro Montes Aguila 
"""
'''
El código proporciona una solución para resolver un Sudoku utilizando el 
algoritmo de backtracking. Se define una función para solucionar el Sudoku, 
verificando la validez de los números colocados en cada celda. Si no se
 encuentra ninguna celda vacía, el Sudoku está resuelto. Si hay una celda 
 vacía, se intentan números del 1 al 9 en esa celda y se llama recursivamente
 a la función hasta encontrar la solución. Si ninguna combinación de números
 es válida, se indica que no hay solución.
'''
