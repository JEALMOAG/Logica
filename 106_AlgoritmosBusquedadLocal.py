...
import random
'''
Este código implementa un algoritmo de búsqueda local para resolver el problema
 de las N reinas en un tablero de ajedrez. Comienza generando un tablero inicial
 aleatorio, luego evalúa la cantidad de ataques entre reinas en el tablero y 
 busca mejorar la disposición moviendo aleatoriamente las reinas a nuevas posiciones.
 Una vez que se encuentra una solución sin ataques entre reinas, se verifica 
 su validez y se imprime si es válida.
'''
